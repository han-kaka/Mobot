...
#define LED_VALUE_MAX_LEN				(20)
#define LED_IND_NTF_CFG_MAX_LEN			(2)

#define LED_SERVER_UUID					{0x9E, 0xCA, 0xDC, 0x24, 0x0E, 0xE5, 0xA9, 0xE0, 0x93, 0xF3, 0xA3, 0xB5 ,0x01, 0x00, 0x40, 0x6E}
#define LED_CHAR_UUIND					{0x9E, 0xCA, 0xDC, 0x24, 0x0E, 0xE5, 0xA9, 0xE0, 0x93, 0xF3, 0xA3, 0xB5 ,0x02, 0x00, 0x40, 0x6E}
#define BUTTON_CHAR_UUIND				{0x9E, 0xCA, 0xDC, 0x24, 0x0E, 0xE5, 0xA9, 0xE0, 0x93, 0xF3, 0xA3, 0xB5 ,0x03, 0x00, 0x40, 0x6E}
...
typedef struct _esprf_led_app_hdl_t
{
	...
	void	(*led_write_req)(uint8_t conidx, uint16_t length, uint8_t *value);
} esprf_led_app_hdl_t;
